...
public class CreateInvoice{
	...
	int totalPages;
	Table table;
	public CreateInvoice(String dest,String appName, Customer customer,Invoice invoice, AppTrn appTrn) throws FileNotFoundException{
...
//		String dest=getServletConfig.getServletContext.getRealPath("/someFolder");
    	...
    	pdfDoc.addEventHandler(PdfDocumentEvent.START_PAGE, new AddHeaderFooter(appName,document,customer,invoice,appTrn,true));
