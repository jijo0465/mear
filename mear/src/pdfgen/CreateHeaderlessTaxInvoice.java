...
public class CreateHeaderlessTaxInvoice{
	Document document;
	PdfDocument pdfDoc;
	int tablePageNum;
	private Customer customer;
	private Invoice invoice;
	public CreateHeaderlessTaxInvoice(String appName, String dest,Customer customer,Invoice invoice, AppTrn appTrn, String doDisplayNo, InvoiceNew invoiceNew) throws FileNotFoundException{
...
//		String dest=getServletConfig.getServletContext.getRealPath("/someFolder");
    	...
    	pdfDoc.addEventHandler(PdfDocumentEvent.START_PAGE, new AddInvoiceHeaderFooter(appName,document,customer,invoice,appTrn,false,doDisplayNo, invoiceNew));
//    	pdfDoc.addEventHandler(PdfDocumentEvent.END_PAGE, new AddFooter(document));
    ...
    public void addInvoiceTable(List<InvoiceItem> invoiceData) {
    	Table table = new Table(new float[]{1,2, 9, 1, 1, 1,1,1,1});
    	table.setWidth(550);
